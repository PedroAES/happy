...
interface NursingHomeDetailsRouteParams {
  id: number;
}
...
export default function NursingHomeDetails() {
  ...
  const params = route.params as NursingHomeDetailsRouteParams;
  ...
  function handleOpenGoogleMapRoutes() {
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${nursingHome?.latitude},${nursingHome?.longitude}`)
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.title}>{nursingHome.name}</Text>
        <Text style={styles.description}>{nursingHome.about}</Text>
        ...
        <Text style={styles.description}>{nursingHome.instructions}</Text>

        <View style={styles.scheduleContainer}>
          <View style={[ styles.scheduleItem, styles.scheduleItemBlue ]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[ styles.scheduleText, styles.scheduleTextBlue ]}>Segunda à Sexta {nursingHome.opening_hours}</Text>
          </View>
